...
*/
-- CreateEnum
CREATE TYPE "VenueStatus" AS ENUM ('DRAFT', 'ACTIVE', 'INACTIVE', 'UNDER_MAINTENANCE', 'REMOVED');

-- CreateEnum
CREATE TYPE "SectionStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'REMOVED');

-- CreateEnum
CREATE TYPE "SeatType" AS ENUM ('STANDARD', 'VIP', 'PREMIUM', 'ACCESSIBLE');

-- CreateEnum
CREATE TYPE "SeatStatus" AS ENUM ('AVAILABLE', 'UNAVAILABLE', 'OUT_OF_SERVICE', 'REMOVED');

-- CreateEnum
CREATE TYPE "CanvasElementType" AS ENUM ('STAGE', 'SCREEN', 'SPEAKER', 'ENTRANCE', 'EXIT', 'CORRIDOR', 'BATHROOM', 'BAR', 'TEXT', 'SHAPE', 'CUSTOM');
...
CREATE TABLE "canvas_elements" (
    "id" UUID NOT NULL,
    "floor_id" UUID NOT NULL,
    "element_type" "CanvasElementType" NOT NULL,
    "name" VARCHAR(150) NOT NULL,
